...
'''
_BIGDATAPATH_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 511,  # num of samples in images/training
        'val': 129,  # num of samples in images/validation
    },
    num_classes=7, #0:normal, 1:DCIS, 2:IDC, 3: LCIS, 4:ILC, 5: OtherTumor, 6:ignore
    ignore_label=255,
)
'''
_BIGDATAPATH_INFORMATION = DatasetDescriptor(
    ...
    num_classes=3, #0:normal, 1:Carcinoma, 255:ignore
    ignore_label=255,
)
...
_DATASETS_INFORMATION = {
    ...
    'bigdatapath': _BIGDATAPATH_INFORMATION,
}
