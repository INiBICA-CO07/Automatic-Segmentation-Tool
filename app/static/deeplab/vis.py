...
flags.DEFINE_string('dataset', 'bigdatapath',
...
def _process_batch(sess, original_images, label_images, semantic_predictions, image_names,
  ...
  (original_images,
   ...
   image_names,
   image_heights,
   image_widths) = sess.run([original_images, label_images, semantic_predictions,
  ...
  for i in range(num_image):
    ...
    label_image = np.squeeze(label_images[i])
    semantic_prediction = np.squeeze(semantic_predictions[i])
    crop_semantic_prediction = semantic_prediction[:image_height, :image_width]
    crop_label_image = label_image[:image_height, :image_width]
      ...
      with sv.managed_session(FLAGS.master,
        ...
        for batch in range(num_batches):
          ...
          _process_batch(sess=sess,
                         ...
                         label_images=samples[common.LABEL],
