...
def add_softmax_cross_entropy_loss_for_each_scale(scales_to_logits,
  ...
  for scale, logits in six.iteritems(scales_to_logits):
    ...
    bigdatapath_weigths = [1., 20.67558911, 7.23330601, 69.18397366, 97.73310573, 43.41094046]

    label0_weight = bigdatapath_weigths[0]
    label1_weight = bigdatapath_weigths[1]
    label2_weight = bigdatapath_weigths[2]
    label3_weight = bigdatapath_weigths[3]
    label4_weight = bigdatapath_weigths[4]
    label5_weight = bigdatapath_weigths[5]
    ignore_weight = 0
